...
def batchify_with_label(input_batch_list, gpu, volatile_flag=False):
    ...
    # if not volatile_flag:
    #     word_seq_tensor.requires_grad = True
    #     biword_seq_tensor.requires_grad = True
    #     label_seq_tensor.requires_grad = True
    ...
    # if not volatile_flag:
    #     char_seq_tensor.requires_grad = True
